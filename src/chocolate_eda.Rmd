...
kable(check_null, format="latex", booktabs=TRUE, 
      col.names = "Null Count",
...
Now we can convert our character columns into factors and also convert cocoa_percent column into a numeric column. Below is the glimpse of our final data after converting the column data types
...
```{r categ_plotgrid, echo=FALSE, message=FALSE, fig.height = 10.5, fig.width = 8}
...
And below are the first 10 rows of our final processed training dataset

```{r final_eda_table_preview, echo=FALSE, message=FALSE}

kable(head(eda_data_final,10), format="latex", booktabs=TRUE, 
