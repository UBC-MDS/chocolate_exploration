...
```{r numeric_plotgrid, echo=FALSE, message=FALSE, fig.cap= "Numeric Plots"}
...
```{r categ_plotgrid, echo=FALSE, message=FALSE, fig.height = 10.5, fig.width = 8, fig.cap="Categorical Plots"}
