...
```
The initial exploratory data analysis for this dataset was performed in R (@R) using the following packages: dplyr (@dplyr), tidyverse (@tidy), cowplot (@cow), knitr (@knitr), and kableExtra (@kableEx).
